...
export const courseApi = {
  ...
  createAssignment:(id: string, data: Record<string, unknown>)=> api.post(`/api/courses/${id}/assignments`, data),
  getQuizzes:  (id: string)    => api.get(`/api/courses/${id}/quizzes`),
  createQuiz:  (id: string, data: Record<string, unknown>)   => api.post(`/api/courses/${id}/quizzes`, data),
  ...
  createAttendanceSession:(id: string, data: Record<string, unknown>)=> api.post(`/api/courses/${id}/attendance`, data),
  ...
  createLiveSession:(id: string, data: Record<string, unknown>)=>api.post(`/api/courses/${id}/live-sessions`,data),
