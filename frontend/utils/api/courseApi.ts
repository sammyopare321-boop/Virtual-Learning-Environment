...
export const courseApi = {
  ...
  createAnnouncement:(id: string, data: { title: string; content: string })=>api.post(`/api/courses/${id}/announcements`,data),
  getDiscussions:(id: string)  => api.get(`/api/courses/${id}/discussions`),
  createDiscussion:(id: string, data: { title: string; content: string })=> api.post(`/api/courses/${id}/discussions`, data),
